...
while (capture.isOpened):
    ...
    if key == 113:  #  종료
        ...
        cv2.imwrite("C:/Users/chltj/Desktop/Coding/PycharmProjects/Tesseract/cap2" + ".jpg", frame)
        pytesseract.pytesseract.tesseract_cmd = r'C:/Program Files/Tesseract-OCR/tesseract.exe'

        text_d = pytesseract.image_to_string(Image.open('cap2.jpg'), lang="kor")
        ...
        plt.scatter(twoxbdata, twoybdata, c='k', s=10)
        plt.scatter(twoxwdata, twoywdata, c='w', s=10)
        plt.axis('off')
        plt.show()
    ...
    if key == 26:  # ctrl + z
        ...
        plt.scatter(figx, figy, c='w', s=10)
        plt.scatter(xbdata, ybdata, c='w', s=10)
        plt.scatter(xwdata, ywdata, c='w', s=10)
        plt.scatter(twoxbdata, twoybdata, c='w', s=10)
        plt.scatter(twoxwdata, twoywdata, c='w', s=10)
        plt.axis('off')
        plt.show()
        break
